...
class Turtlesim_3_Drawer:
    def __init__(self):
        rclpy.init()

        self.node = rclpy.create_node('turtlesim_3_drawer')
    ...
    def draw_3(self):
        # 3 Sayısını çizmek için hareket komutları
        self.move_turtle(2.0, 1.0, 3.0)   
        time.sleep(2.0)
